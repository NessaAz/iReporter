    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('info', models.CharField(blank=True, max_length=1050)),
                ('created', models.DateTimeField(auto_now_add=True, null=True)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='flags', to='app.client')),
            ],
            options={
                'ordering': ['-pk'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('info', models.CharField(blank=True, max_length=1050)),
                ('created', models.DateTimeField(auto_now_add=True, null=True)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='interventions', to='app.client')),
            ],
            options={
                'ordering': ['-pk'],
            },
